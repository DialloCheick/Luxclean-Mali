      ...
      <header className="sticky top-0 z-40 bg-[#070e1f]/95 backdrop-blur-md border-b border-[#C5A869]/20 text-white transition-all shadow-xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <div className="hidden sm:flex items-center gap-3">
            <button
              onClick={onOpenQuote}
              className="px-4 py-2.5 text-sm font-semibold text-white hover:text-[#DFC792] bg-[#0d1a38] hover:bg-[#13254e] border border-[#C5A869]/30 hover:border-[#C5A869]/60 rounded-xl transition-all flex items-center gap-2 cursor-pointer shadow-sm"
            >
            ...
            <button
              ...
              className="px-5 py-2.5 text-sm font-bold text-[#060B16] bg-gold-gradient rounded-xl shadow-md hover:shadow-lg transition-all flex items-center gap-2 cursor-pointer font-display tracking-wide transform hover:-translate-y-0.5"
            >
              <Calendar className="w-4 h-4 text-[#060B16]" />
          ...
          <div className="flex items-center gap-2 lg:hidden">
            <button
              onClick={onOpenBooking}
              className="sm:hidden px-3.5 py-1.5 text-xs font-bold text-[#060B16] bg-gold-gradient rounded-lg shadow-sm"
            >
              RDV
            </button>
            <button
